...
import json
import subprocess
from ID_Obfuscation.obf_tool.collect_identifiers import collect_identifiers
from ID_Obfuscation.obf_tool.change_name import change_name
from ID_Obfuscation.obf_tool.change_name import remove_tagging
...
def id_obfuscation():
    os.makedirs("./ID_Obfuscation/output/", exist_ok=True)
    identifier_info, all_identifier_info = collect_identifiers()
    identifier_path = "./ID_Obfuscation/output/identifier.json"
    ...
    all_identifier_path = "./ID_Obfuscation/output/all_identifier.json"
    ...
    cmd = ["python3", "./ID_Obfuscation/mapping_tool/service_mapping.py", 
